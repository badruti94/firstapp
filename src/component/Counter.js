...
const Counter = () => {
    ...
    return (
        <div>
            ...
            <p></p>
            <ButtonGroup>
                <Button color="dark" onClick={() => dispatch2({ type: 'increment', payload:1 })} >increment Counter 2</Button>
                <Button color="dark" onClick={() => dispatch2({ type: 'decrement', payload:1 })} >decrement Counter 2</Button>
